        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg shadow-[0_4px_12px_rgba(0,0,0,0.05)] w-full">
          ...
          {activeTab === "citizen" && (
            <form onSubmit={async (e) => {
              ...
              <a href={`${process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000/api/v1"}/auth/google/login?action=signup`} className="w-full flex items-center justify-center gap-xs bg-surface-container-lowest border border-outline-variant hover:bg-surface-variant text-on-surface rounded-lg py-3 px-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
